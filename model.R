...
bigram <- read_rds('data/2gram.Rda')
trigram <- read_rds('data/3gram.Rda')
fourgram <- read_rds('data/4gram.Rda')
fivegram <- read_rds('data/5gram.Rda')
sixgram <- read_rds('data/6gram.Rda')
