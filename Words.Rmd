...
Well, I see that the most informative from all these files is the one containing blogs. Twitter's 99%-percentile is less than others' 30-50%. I will not use twitter for teaching my model at all. How much of each source should be left? Let it be the something close to 99.99%-percentiles (3000, 1500 and 142 symbols respectively). It will contain about 1200 lines of text:
